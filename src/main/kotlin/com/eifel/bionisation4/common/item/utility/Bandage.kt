...
class Bandage(): Item(Properties().tab(BionisationTab.BIONISATION_TAB).rarity(Rarity.UNCOMMON).stacksTo(64)) {
    ...
    override fun appendHoverText(stack: ItemStack, world: World?, info: MutableList<ITextComponent>, flag: ITooltipFlag) {
        ...
        info.add(TranslationUtils.getText("${TextFormatting.GOLD}${TranslationUtils.getTranslatedText("bandage", "usage", "desc")}"))
    }
}