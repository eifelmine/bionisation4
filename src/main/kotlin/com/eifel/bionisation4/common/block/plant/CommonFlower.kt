...
class CommonFlower(effect: Effect, val shape: VoxelShape = box(5.0, 0.0, 5.0, 11.0, 14.0, 11.0), val placing: (BlockState, IBlockReader, BlockPos) -> Boolean = {state, reader, pos -> true}): FlowerBlock(effect, 1, Properties.copy(Blocks.DANDELION)) {
