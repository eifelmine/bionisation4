...
class DNAModifierRecipeCategory(val helper: IGuiHelper) : IRecipeCategory<DNAModifierRecipe> {
    ...
    override fun getTitle() = TextComponent(TranslationUtils.getTranslatedText("jei", "title", "dna_modifier"))
    ...
    override fun draw(recipe: DNAModifierRecipe, matrixStack: PoseStack, mouseX: Double, mouseY: Double) {
