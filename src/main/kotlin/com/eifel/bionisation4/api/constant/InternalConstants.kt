...
object InternalConstants {
    ...
    val DISCOVERED_EFFECTS = getModIDString("eff_discovered")
    ...
    val BACTERIA_GLOWING_ID = 702
    val BACTERIA_WATER_ID = 703
    val BACTERIA_ENDER_ID = 704
    val BACTERIA_CACTUS_ID = 705
    val BACTERIA_BONE_ID = 706
    val BACTERIA_TERRA_ID = 707
    val BACTERIA_MYCELIUM_ID = 708
    val BACTERIA_SEA_ID = 709
    val BACTERIA_CLONE_ID = 710
}